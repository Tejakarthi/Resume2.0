...
export const ABOUT_TOPICS: AboutTopic[] = [
    {
        ...
        content: [
            <>
                Hi There! I'm{" "}
                <span className={boldStyle}>Arun kumar M</span>, a
                24-year-old developer living in Medavakkam, Chennai.
            </>,
            <>
                ...
                <span className={boldStyle}>Backend-Tool</span> and{" "}
                <span className={boldStyle}>Streaming-Service</span> development. My diverse
